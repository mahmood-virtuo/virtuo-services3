                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb__content">
                                <h2 class="title">Brand Development</h2>
                                <nav class="breadcrumb">
                                    <span property="itemListElement" typeof="ListItem"><a href="index-5.php">Home</a></span>
                                    <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                                    <span property="itemListElement" typeof="ListItem">Brand Development</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-70 order-0 order-lg-2">
                            <!-- Brand Identity Design Tab Panel -->
                            <div class="service-tab-panel is-active" id="brand-development-brand-identity-design" data-service-panel="brand-development-brand-identity-design">
                                <div class="services__details-wrap">
                                    ...
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Brand Identity Design">
                                    </div>
                                    <div class="services__details-content">
                                        ...
                                        <div class="services__details-inner-images">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="img-one">
                                                        <img src="assets/img/services/services_img01.jpg" alt="Brand Identity Design">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="img-two">
                                                        <img src="assets/img/services/services_img02.jpg" alt="Brand Identity Design">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!-- Brand Identity Design Tab Panel End --><!-- Brand Identity Design Tab Panel End -->
                            <!-- Graphic Design Tab Panel -->
                            <div class="service-tab-panel" id="brand-development-graphic-design" data-service-panel="brand-development-graphic-design">
                                <div class="services__details-wrap">
                                    <div class="services__details-content-top">
                                    ...
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Graphic Design">
                                    </div>
                                    <div class="services__details-content">
                                        ...
                                        <div class="services__details-inner-images">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="img-one">
                                                        <img src="assets/img/services/services_img01.jpg" alt="Graphic Design">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="img-two">
                                                        <img src="assets/img/services/services_img02.jpg" alt="Graphic Design">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!-- Graphic Design Tab Panel End --><!-- Graphic Design Tab Panel End -->
                            <!-- Video Production &amp; Motion Graphics Tab Panel -->
                            <div class="service-tab-panel" id="brand-development-video-production-and-motion-graphics" data-service-panel="brand-development-video-production-and-motion-graphics">
                                <div class="services__details-wrap">
                                    <div class="services__details-content-top">
                                    ...
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Video Production &amp; Motion Graphics">
                                    </div>
                                    <div class="services__details-content">
                                        ...
                                        <div class="services__details-inner-images">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="img-one">
                                                        <img src="assets/img/services/services_img01.jpg" alt="Video Production &amp; Motion Graphics">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="img-two">
                                                        <img src="assets/img/services/services_img02.jpg" alt="Video Production &amp; Motion Graphics">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!-- Video Production &amp; Motion Graphics Tab Panel End --><!-- Video Production &amp; Motion Graphics Tab Panel End -->
                            <!-- Marketing Collateral Design Tab Panel -->
                            <div class="service-tab-panel" id="brand-development-marketing-collateral-design" data-service-panel="brand-development-marketing-collateral-design">
                                <div class="services__details-wrap">
                                    <div class="services__details-content-top">
                                    ...
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Marketing Collateral Design">
                                    </div>
                                    <div class="services__details-content">
                                        ...
                                        <div class="services__details-inner-images">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="img-one">
                                                        <img src="assets/img/services/services_img01.jpg" alt="Marketing Collateral Design">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="img-two">
                                                        <img src="assets/img/services/services_img02.jpg" alt="Marketing Collateral Design">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!-- Marketing Collateral Design Tab Panel End --><!-- Marketing Collateral Design Tab Panel End -->
                            <!-- Creative Direction &amp; Concept Development Tab Panel -->
                            <div class="service-tab-panel" id="brand-development-creative-direction-and-concept-development" data-service-panel="brand-development-creative-direction-and-concept-development">
                                <div class="services__details-wrap">
                                    <div class="services__details-content-top">
                                    ...
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Creative Direction &amp; Concept Development">
                                    </div>
                                    <div class="services__details-content">
                                        ...
                                        <div class="services__details-inner-images">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="img-one">
                                                        <img src="assets/img/services/services_img01.jpg" alt="Creative Direction &amp; Concept Development">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="img-two">
                                                        <img src="assets/img/services/services_img02.jpg" alt="Creative Direction &amp; Concept Development">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!-- Creative Direction &amp; Concept Development Tab Panel End --><!-- Creative Direction &amp; Concept Development Tab Panel End -->
                        </div>
                        <div class="col-30">
                            <aside class="services__sidebar">
                                <div class="sidebar__widget">
                                    <div class="sidebar__cat-list">
                                        <ul class="list-wrap">
                                            <li>
                                                <a href="#brand-development-brand-identity-design" class="service-tab-link is-active" data-service-tab="brand-development-brand-identity-design">
                                            ...
                                            <li>
                                                <a href="#brand-development-graphic-design" class="service-tab-link" data-service-tab="brand-development-graphic-design">
                                                    Graphic Design
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="14" viewBox="0 0 24 14" fill="none">
                                                            <path d="M1 6.7777H22.6667M22.6667 6.7777L16.9683 1M22.6667 6.7777L16.9683 12.5556" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            ...
                                            <li>
                                                <a href="#brand-development-video-production-and-motion-graphics" class="service-tab-link" data-service-tab="brand-development-video-production-and-motion-graphics">
                                            ...
                                            <li>
                                                <a href="#brand-development-marketing-collateral-design" class="service-tab-link" data-service-tab="brand-development-marketing-collateral-design">
                                            ...
                                            <li>
                                                <a href="#brand-development-creative-direction-and-concept-development" class="service-tab-link" data-service-tab="brand-development-creative-direction-and-concept-development">
