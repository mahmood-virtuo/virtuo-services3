                    ...
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem">Pricing table</span>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <section class="pricing__area section-py-130">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section__title text-center mb-30">
                            <h2 class="title">Select your Pricing Plan</h2>
                        </div>
                    </div>
                </div>
                <div class="pricing__tab">
                    ...
                    <span class="tab-btn annual_tab_title">Yearly <strong>save 20%</strong></span>
                </div>
                <div class="row justify-content-center gutter-y-30">
                    <div class="col-lg-4 col-md-6">
                        <div class="pricing__box">
                            <div class="pricing__top">
                                ...
                                <p>For anyone who wants to try making their first demos.</p>
                            </div>
                            <div class="pricing__price">
                                <h2 class="price monthly_price">$19.00<span>/Per month</span></h2>
                                <h2 class="price annual_price">$119.00<span>/Per year</span></h2>
                            </div>
                            <div class="pricing__button">
                                <a href="#!" class="tg-btn">Get Started <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                            </div>
                            <div class="pricing__list">
                                <h5 class="pricing__list-title">Features:</h5>
                                <ul class="list-wrap">
                                    <li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="pricing__box">
                            <div class="pricing__top">
                                <h5 class="title">Business Plan</h5>
                                <p>For anyone who wants to try making their first demos.</p>
                            </div>
                            <div class="pricing__price">
                                <h2 class="price monthly_price">$99.00<span>/Per month</span></h2>
                                <h2 class="price annual_price">$599.00<span>/Per year</span></h2>
                            </div>
                            <div class="pricing__button">
                                <a href="#!" class="tg-btn">Get Started <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="pricing__box">
                            ...
                            <div class="pricing__price">
                                <h2 class="price monthly_price">$199.00<span>/Per month</span></h2>
                                <h2 class="price annual_price">$999.00<span>/Per year</span></h2>
                            </div>
                            <div class="pricing__button">
                                <a href="#!" class="tg-btn">Get Started <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                            </div>
