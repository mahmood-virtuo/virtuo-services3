...
<body>
                                    ...
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Portfolio</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="project-details-5.php">Portfolio Details Five</a></li>
                                            </ul>
                                        </li>
    ...
    <main class="main-area fix">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="breadcrumb__content breadcrumb__content-two">
                            <h2 class="title">Engage & Convert with Powerful Email Marketing</h2>
        ...
        <section class="project__details-area-two section-pb-130">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="project__details-thumb-six">
                            <img src="assets/img/project/pd5_img01.jpg" alt="">
                        </div>
                        <div class="project__details-info-wrap-four">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="project__details-info-item project__details-info-item-two">
                                        <div><span>Project Name:</span>Web Development</div>
                                        <div><span>Client Name:</span>Robert Richard</div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="project__details-info-item project__details-info-item-two">
                                        <div><span>Start Date:</span>12.07.2023</div>
                                        <div><span>Project Duration:</span>6 Month</div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="project__details-info-item project__details-info-item-two">
                                        <div><span>Location:</span>Los Angeles</div>
                                        <div><span>Share Project:</span>
                                            <ul class="list-wrap">
                                                <li><a href="#"><img src="assets/img/icons/facebook.svg" alt="" class="injectable"></a></li>
                                                <li><a href="#"><img src="assets/img/icons/instagram.svg" alt="" class="injectable"></a></li>
                                                <li><a href="#"><img src="assets/img/icons/twitter.svg" alt="" class="injectable"></a></li>
                                                <li><a href="#"><img src="assets/img/icons/pinterest.svg" alt="" class="injectable"></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="project__details-wrap">
                            <div class="project__details-content-two">
                                ...
                                <p>Boost your business with our result-driven email marketing services. We craft engaging email campaigns that build relationships, increase conversions, and drive customer loyalty. Whether you're looking to nurture leads, promote your products, or retain customers, our tailored solutions ensure maximum impact.</p>
                                <div class="project__details-overview">
                                    <h2 class="title">Project Overview</h2>
                                    <p>Our living room interior design project is centred around transforming the living space of our valued client, Christopher. With a focus on creating a warm, inviting, and functional living room, our goal is to curate a space that reflects the client's unique style, enhances comfort, and fosters a welcoming ambiance for relaxation and socialising.</p>
                                    <p><span>Style and Aesthetics:</span> Our objective is to understand the client's preferred style and design preferences for their living room. Whether it's contemporary, modern, traditional, or eclectic</p>
                                    <p><span>Space Planning and Layout:</span> We will carefully consider the layout and flow of the living room to maximize functionality and optimize the available space.</p>
                                    <p><span>Personalization and Finishing Touches:</span> Our objective is to add personal touches and curated details that make the living room unique and reflective of the client's individuality.</p>
                                    <img src="assets/img/project/pd5_img02.jpg" alt="img">
                                </div>
                                <div class="project__details-challenge-wrap-three">
                                    <h2 class="title">Project Challenge:</h2>
                                    <p>Building regulations and permits: Urban areas typically have strict building regulations and permit requirements. It is crucial to thoroughly research and understand the local building codes and ensure compliance throughout the project. Engage with relevant authorities early in the planning process to streamline the permitting process.</p>
                                    <img src="assets/img/project/pd5_img03.jpg" alt="img">
                                    <div class="project__details-challenge-two">
                                        <ul class="list-wrap about__list-item">
                                            <li>
                                                ...
                                                Not all emails reach the recipient’s inbox; some end up in spam folders. This can be due to poor email lists, lack of authentication (SPF, DKIM, DMARC), or overly promotional content.
                                            </li>
                                            <li>
                                                <div class="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                                ...
                                                Even if emails are delivered, getting recipients to open them is another challenge. Weak subject lines, lack of personalization, and poor send timing can contribute to low engagement.
                                            </li>
                                            <li>
                                                <div class="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                                ...
                                                If subscribers find emails irrelevant, too frequent, or overly sales-driven, they may unsubscribe. Maintaining a balance between promotional and value-driven content is crucial.
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="project__details-marketing">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="assets/img/project/pd5_img04.jpg" alt="img">
                                        </div>
                                        <div class="col-md-6">
                                            <div class="project__details-challenge-two">
                                                <h2 class="title-two">Our Email Marketing Solutions:</h2>
                                                <ul class="list-wrap about__list-item">
                                                    <li>
                                                        <div class="icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                                        ...
                                                        Customized Campaigns – Professionally designed email templates that align with your brand.
                                                    </li>
                                                    <li>
                                                        <div class="icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                                        ...
                                                        Udience Segmentation – Target the right people at the right time for higher engagement.
                                                    </li>
                                                    <li>
                                                        <div class="icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                                        ...
                                                        Automated Workflows – Set up automated sequences to nurture leads effortlessly.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-4">
                        <aside class="project__sidebar-two">
                            <div class="sidebar__widget">
                                <div class="project__details-contact-two">
                                    <span class="sub-title">Contact</span>
                                    <h2 class="title">Let's start new project.</h2>
                                    <form action="#" class="project__details-form">
                                        <div class="form-grp">
                ...
                <div class="project__details-bottom-wrap">
                    <a href="project-details.php" class="previous-post"><img src="assets/img/icons/right_arrow.svg" alt="icon" class="injectable">Previous</a>
                    <a href="project.php" class="all-post">
                        <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="7.04688" width="4" height="4" fill="currentColor" />
                            <rect x="7.04688" y="7.03809" width="4" height="4" fill="currentColor" />
                            <rect x="7.04688" y="14.0762" width="4" height="4" fill="currentColor" />
                            <rect x="0.0625" width="4" height="4" fill="currentColor" />
                            <rect x="0.0625" y="7.03809" width="4" height="4" fill="currentColor" />
                            <rect x="0.0625" y="14.0762" width="4" height="4" fill="currentColor" />
                            <rect x="14.0703" width="4" height="4" fill="currentColor" />
                            <rect x="14.0703" y="7.03809" width="4" height="4" fill="currentColor" />
                            <rect x="14.0703" y="14.0762" width="4" height="4" fill="currentColor" />
                        </svg>
                    </a>
                    <a href="project-details.php" class="next-post"><img src="assets/img/icons/right_arrow.svg" alt="icon" class="injectable">Next</a>
                </div>
            </div>
        </section>
