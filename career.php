                                    ...
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Pages</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="career.php">Career Page</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="breadcrumb__content breadcrumb__content-two">
                            <h2 class="title">Join Our Team of Innovators <br> and Problem Solvers</h2>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        ...
                        <div class="career__content">
                            <p>We believe that our people are our greatest asset. We are committed to fostering a collaborative, inclusive, and dynamic work environment where every team member can thrive. If you are passionate about technology and dedicated to delivering exceptional IT solutions, we want to hear from you!</p>
                            <a href="#" class="tg-btn tg-btn-three">Current Openings</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-10">
                        <div class="work__thumb">
                            <img src="assets/img/images/inner_wrok_img.jpg" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="work__content-three">
                            ...
                            <p>We believe that our people are our greatest asset. We are committed to fostering a collaborative, inclusive, and dynamic work environment</p>
                    ...
                    <div class="col-lg-6">
                        <div class="career__item">
                            <div class="career__item-content">
                                ...
                                <p><span>Job Summary:</span> A Business Analyst bridges the gap between business needs and technology solutions. They analyse data, identify business challenges, and propose strategic solutions.</p>
                                <p><span>Requirements:</span> Bachelor’s degree in Business, Finance, IT, or a related field. 1-3 years of experience in business analysis, consulting, or a related role. Certifications like CBAP (Certified Business Analysis Professional) or PMI-PBA are a plus.</p>
                            </div>
                            <ul class="list-wrap">
                            ...
                            <div class="career__item-bottom">
                                <h4 class="salary">$1000 - $12000 <span>USD/month</span></h4>
                                <a href="career-details.php" class="tg-btn tg-btn-three">Apply Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-5 col-md-8">
                        <div class="faq__img-three">
                            <img src="assets/img/images/inner_faq_img.jpg" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="faq__wrap">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            How do I apply for a job at Bekko?
                                        </button>
                                    </h2>
                                    <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <p>You can apply directly through our Careers page. Simply select the position you’re interested in, click “Apply Now,” and submit your resume and cover letter.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Do you accept applications via email or in person?
                                        </button>
                                    </h2>
