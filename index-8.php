...
<body>
    ...
    <header>
        ...
        <div id="sticky-header" class="tg-header__area tg-header__area-eight">
            <div class="container custom-container-five">
                <div class="row">
                    <div class="col-12">
                        <div class="tgmenu__wrap">
                            <nav class="tgmenu__nav">
                                            ...
                                            <ul class="sub-menu tg-mega-menu-wrap-two">
                                                ...
                                                <li>
                                                    <ul class="mega-sub-menu">
                                                        ...
                                                        <li class="active"><a href="index-5.php">Online Banking</a></li>
                                ...
                                <div class="tgmenu__action tgmenu__action-eight">
                                    <ul class="list-wrap">
                                        ...
                                        <li class="header-btn">
                                            <a href="contact.php" class="tg-btn">Login</a>
                                        </li>
                                    </ul>
                                </div>
    ...
    <main class="main-area fix">
        ...
        <section class="banner__area-five">
            <div class="container custom-container-five">
                <div class="banner__bg-four" data-background="assets/img/banner/h8_hero_bg.jpg">
                    <div class="banner__bg-shape" data-background="assets/img/banner/h8_hero_bg_shape.svg"></div>
                    <div class="row">
                        <div class="col-xl-6 col-lg-8">
                            <div class="banner__content-five">
                                <span class="sub-title" data-aos="fade-up" data-aos-delay="200">Your Money, Your Way</span>
                                <h2 class="title" data-aos="fade-up" data-aos-delay="400"><span>Digital</span> Banking Made <span>Life Easier</span></h2>
                                <p data-aos="fade-up" data-aos-delay="600">Agilos helps you to convert your datatrategic asset hernd get top-notch business insights.</p>
                                <div class="banner__btn" data-aos="fade-up" data-aos-delay="800">
                                    <a href="contact.php" class="tg-btn">Open an Account <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section__title text-center mb-40">
                            <h2 class="title">Make Our Online Banking <br> Easier & Comfortable</h2>
                ...
                <div class="row gutter-y-30 justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="services__item-eight">
                            <div class="services__item-top">
                                <div class="services__icon-four">
                                    <i class="flaticon-wallet"></i>
                                </div>
                                <h2 class="title">
                                    <a href="services-details.php">Incredibly <br> Controlled Bills</a>
                                </h2>
                            </div>
                            <div class="services__content-eight">
                                <p>Insurbes companies work toget sense more security peahey have insurance coverage challenging times.</p>
                                <a href="services-details.php" class="tg-btn">Read More <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="services__item-eight">
                            <div class="services__item-top">
                                ...
                                <h2 class="title">
                                    <a href="services-details.php">Unbelievable <br> Quick Payments</a>
                                </h2>
                            </div>
                            <div class="services__content-eight">
                                <p>Insurbes companies work toget sense more security peahey have insurance coverage challenging times.</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="services__item-eight">
                            <div class="services__item-top">
                                ...
                                <h2 class="title">
                                    <a href="services-details.php">Online Way <br> Deposit</a>
                                </h2>
                            </div>
                            <div class="services__content-eight">
                                <p>Insurbes companies work toget sense more security peahey have insurance coverage challenging times.</p>
                    ...
                    <h4 class="title">Over
                        <span>35K
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="7" viewBox="0 0 50 7" fill="none">
                                <path d="M0.99992 5.59566C9.42209 2.58449 30.6892 -1.69455 48.3803 5.27862"
        ...
        <!-- history-area -->
        <section class="history__area-four section-py-130">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="history__img-wrap-four">
                            <img src="assets/img/images/h8_history_img.jpg" alt="img" data-aos="fade-right" data-aos-delay="200">
                            <img src="assets/img/images/h8_history_img_shape.svg" alt="shape" class="shape" data-aos="fade-right" data-aos-delay="200">
                            <div class="history__rating" data-aos="fade-up" data-aos-delay="400">
                                <img src="assets/img/images/about_celint_img.png" alt="">
                                <span>Avg rating <strong>4.8</strong> <br> world best Bank.</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="history__content-four">
                            <div class="section__title mb-20">
                                <span class="sub-title">About Our Banking History</span>
                                <h2 class="title">Transfer & Deposited Money Anytime In The World</h2>
                            </div>
                            <p>Transform your business with our transformative consulting We go beyond short-term fixes to deliver sustainable growth strategies that futurproof your enterprisewith our transformative consulting.</p>
                            <div class="history__content-inner-two">
                                <div class="planning__box planning__box-two">
                                    <div class="icon">
                                        <i class="flaticon-insurance"></i>
                                    </div>
                                    <div class="content">
                                        <h4 class="title">Secure Transfer <br> Money</h4>
                                    </div>
                                </div>
                                <div class="planning__box planning__box-two">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        <h4 class="title">Deposit Money <br> In a Second</h4>
                                    </div>
                                </div>
                            </div>
                            <ul class="list-wrap about__list-item about__list-item-four">
                                <li>
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                            <path d="M11.5252 3.5L5.30301 9.72222L2.47473 6.89394" stroke="currentColor" stroke-width="1.6"
                            ...
                            <a href="about.php" class="tg-btn">Check Our Facilities <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- services-area -->
        <section class="services__area-eight services__bg-four section-py-130" data-background="assets/img/bg/h8_services_bg.png">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-8">
                        <div class="section__title white-title text-center mb-50">
                            <span class="sub-title">Popular Banking Services</span>
                            <h2 class="title">Services Built Specifically for your Business</h2>
                        </div>
                    </div>
                </div>
                <div class="services__item-wrap-two">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="itemOne-tab" data-bs-toggle="tab" data-bs-target="#itemOne-tab-pane" type="button" role="tab" aria-controls="itemOne-tab-pane" aria-selected="true">
                                <span class="content__left">
                                    ...
                                    <strong>Online Mobile <br> Banking</strong>
                                </span>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="itemTwo-tab" data-bs-toggle="tab" data-bs-target="#itemTwo-tab-pane" type="button" role="tab" aria-controls="itemTwo-tab-pane" aria-selected="false">
                                <span class="content__left">
                                    ...
                                    <strong>Banking Loan <br> Service</strong>
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="14" viewBox="0 0 22 14" fill="none">
                                    <path d="M1 7H21M21 7L15.1421 1.14214M21 7L15.1421 12.8579" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="itemThree-tab" data-bs-toggle="tab" data-bs-target="#itemThree-tab-pane" type="button" role="tab" aria-controls="itemThree-tab-pane" aria-selected="false">
                                <span class="content__left">
                                    ...
                                    <strong>Bank Investment <br> Service</strong>
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="14" viewBox="0 0 22 14" fill="none">
                                    <path d="M1 7H21M21 7L15.1421 1.14214M21 7L15.1421 12.8579" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="itemFour-tab" data-bs-toggle="tab" data-bs-target="#itemFour-tab-pane" type="button" role="tab" aria-controls="itemFour-tab-pane" aria-selected="false">
                                <span class="content__left">
                                    ...
                                    <strong>Internet Agent <br> Banking</strong>
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="14" viewBox="0 0 22 14" fill="none">
                                    <path d="M1 7H21M21 7L15.1421 1.14214M21 7L15.1421 12.8579" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="itemFive-tab" data-bs-toggle="tab" data-bs-target="#itemFive-tab-pane" type="button" role="tab" aria-controls="itemFive-tab-pane" aria-selected="false">
                                <span class="content__left">
                                    ...
                                    <strong>Pay Out & <br> Refund</strong>
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="14" viewBox="0 0 22 14" fill="none">
                                    <path d="M1 7H21M21 7L15.1421 1.14214M21 7L15.1421 12.8579" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="itemOne-tab-pane" role="tabpanel" aria-labelledby="itemOne-tab" tabindex="0">
                            <div class="services__item-nine shine__animate-item">
                                <div class="services__thumb-seven shine__animate-link">
                                    <a href="services-details.php"><img src="assets/img/services/h8_services_img01.jpg" alt="img"></a>
                                </div>
                                <div class="services__content-nine">
                                    <h2 class="title"><a href="services-details.php">Online Mobile Banking</a></h2>
                                    <p>Transform your business with our mobile banking transformative way offer short-term fixes to deliver sustainable growth strategies.</p>
                                    <a href="services-details.php" class="tg-btn tg-btn-four"><img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable"></a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="itemTwo-tab-pane" role="tabpanel" aria-labelledby="itemTwo-tab" tabindex="0">
                            <div class="services__item-nine shine__animate-item">
                                <div class="services__thumb-seven shine__animate-link">
                                    <a href="services-details.php"><img src="assets/img/services/h8_services_img02.jpg" alt="img"></a>
                                </div>
                                <div class="services__content-nine">
                                    <h2 class="title"><a href="services-details.php">Banking Loan Service</a></h2>
                                    <p>Transform your business with our mobile banking transformative way offer short-term fixes to deliver sustainable growth strategies.</p>
                                    <a href="services-details.php" class="tg-btn tg-btn-four"><img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable"></a>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="itemThree-tab-pane" role="tabpanel" aria-labelledby="itemThree-tab" tabindex="0">
                            <div class="services__item-nine shine__animate-item">
                                <div class="services__thumb-seven shine__animate-link">
                                    <a href="services-details.php"><img src="assets/img/services/h8_services_img03.jpg" alt="img"></a>
                                </div>
                                <div class="services__content-nine">
                                    <h2 class="title"><a href="services-details.php">Bank Investment Service</a></h2>
                                    <p>Transform your business with our mobile banking transformative way offer short-term fixes to deliver sustainable growth strategies.</p>
                                    <a href="services-details.php" class="tg-btn tg-btn-four"><img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable"></a>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="itemFour-tab-pane" role="tabpanel" aria-labelledby="itemFour-tab" tabindex="0">
                            <div class="services__item-nine shine__animate-item">
                                ...
                                <div class="services__content-nine">
                                    <h2 class="title"><a href="services-details.php">Internet Agent Banking</a></h2>
                                    <p>Transform your business with our mobile banking transformative way offer short-term fixes to deliver sustainable growth strategies.</p>
                                    <a href="services-details.php" class="tg-btn tg-btn-four"><img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable"></a>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="itemFive-tab-pane" role="tabpanel" aria-labelledby="itemFive-tab" tabindex="0">
                            <div class="services__item-nine shine__animate-item">
                                ...
                                <div class="services__content-nine">
                                    <h2 class="title"><a href="services-details.php">Pay Out & Refund</a></h2>
                                    <p>Transform your business with our mobile banking transformative way offer short-term fixes to deliver sustainable growth strategies.</p>
                                    <a href="services-details.php" class="tg-btn tg-btn-four"><img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable"></a>
                                </div>
                            </div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-7 col-md-9 order-0 order-lg-2">
                        <div class="choose__img-wrap-four">
                            <img src="assets/img/images/h8_choose_img.jpg" alt="img" data-aos="fade-left" data-aos-delay="200">
                            ...
                            <div class="circle__wrap circle__wrap-two" data-aos="zoom-in" data-aos-delay="600">
                                ...
                                <div class="content">
                                    <h6 class="circle rotateme">Since 1998 Digital . Business . Agency . </h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="choose__content-five">
                            <div class="section__title mb-15">
                                ...
                                <h2 class="title">Smooth Banking solutions for every stage</h2>
                            </div>
                            <p>Transform your business with our ransforative consulting go beyond short-term fixes to deliver inabgro.</p>
                            <ul class="list-wrap about__list-item">
                                ...
                                <li>
                                    ...
                                    Short term of Investment Process
                                </li>
                                <li>
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
        ...
        <!-- counter-area -->
        <section class="counter__area-two counter__area-six section-pb-130">
            <div class="container">
        ...
        <!-- cta-area -->
        <section class="cta__area-five cta__area-six">
            <div class="container">
                <div class="row align-items-center">
            ...
            <div class="cta__shape-wrap-two">
                <img src="assets/img/images/h8_cta_shape01.svg" alt="shape">
                <img src="assets/img/images/h8_cta_shape02.svg" alt="shape">
            </div>
        </section>
        <!-- cta-area-end -->
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="work__item-two text-center">
                                ...
                                <div class="work__content-two">
                                    ...
                                    <h3 class="title">Choose Service</h3>
                                    <p>Transform your business with ourtransfo reive consulting solutione go beyond short-term fixes to deliver</p>
                                </div>
                            </div>
                        </div>
