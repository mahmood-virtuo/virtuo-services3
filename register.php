                            ...
                            <form action="#" class="login__form">
                                ...
                                <div class="account__check">
                                    <div class="account__check-remember">
                                        ...
                                        <label for="terms-check" class="form-check-label">I read and accept the <a href="contact.php">terms of use</a></label>
                                    </div>
                                </div>
                                <button type="submit" class="tg-btn tg-btn-three">Create my account <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></button>
                            </form>
