                                ...
                                <div class="tgmenu__action tgmenu__action-two">
                                    <ul class="list-wrap">
                                        <li class="header-btn header-btn-two">
                                            <a href="contact.php" class="tg-btn">Sing Up</a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content-two">
                            ...
                            <a href="contact.php" class="tg-btn">Contact With Us <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="project__area-two section-py-130">
            <div class="container">
                ...
                <div class="view__all-btn text-center mt-50">
                    <a href="project.php" class="tg-btn">See all Projects <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                </div>
            </div>
        </section>
        <!-- project-area-end -->
