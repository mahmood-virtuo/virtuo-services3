                                    ...
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Services</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="services-details-2.php">Services Details Two</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <h2 class="title">Comprehensive Tax Advisory Services</h2>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-10 order-0 order-lg-2">
                        <div class="features__img">
                            <img src="assets/img/services/sd2_img01.jpg" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="features__content-two">
                            <div class="section__title mb-25">
                                ...
                                <h2 class="title">Core Components of Our Market Analysis Services</h2>
                            </div>
                            ...
                            <ul class="list-wrap about__list-item-two">
                                <li>
                                    ...
                                    Assistance with filing personal and corporate tax returns.
                                </li>
                                <li>
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="11" viewBox="0 0 14 11" fill="none">
                                    ...
                                    Developing strategies to minimize tax obligations legally.
                                </li>
                                <li>
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="11" viewBox="0 0 14 11" fill="none">
                                    ...
                                    Structuring transactions to maximise tax benefits.
                                </li>
                            </ul>
                            <a href="contact.php" class="tg-btn tg-btn-three">Let’s Talk <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-item-center justify-content-center">
                    <div class="col-lg-5 col-md-10">
                        <div class="features__img">
                            <img src="assets/img/services/sd2_img02.jpg" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="features__content-three">
                            ...
                            <p>From compliance to advanced tax strategies, our experts work to ensure you achieve financial efficiency, minimise liabilities, and maintain compliance with evolving regulations.</p>
                            ...
                            <ul class="list-wrap about__list-item-two about__list-item-four">
                                <li>
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="11" viewBox="0 0 14 11" fill="none">
                                            <path d="M12.091 2L5.091 9L1.90918 5.81818" stroke="currentColor" stroke-width="2.1875" stroke-linecap="round" stroke-linejoin="round" />
