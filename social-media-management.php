                        ...
                        <div class="col-12">
                            <div class="breadcrumb__content">
                                ...
                                <nav class="breadcrumb">
                                    ...
                                    <span property="itemListElement" typeof="ListItem">Social Media Management</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-70 order-0 order-lg-2">
                            ...
                            <div class="service-tab-panel is-active" id="social-media-management-social-media-management" data-service-panel="social-media-management-social-media-management">
                                <div class="services__details-wrap">
                                    <div class="services__details-content-top">
                                        ...
                                        <p>Social Media Management requires careful planning, accurate documentation, and timely coordination with the right digital platforms, creative workflows, and business goals.</p>
                                        <p>Virtuo supports every step of social media management, helping your team build stronger digital assets, clearer campaigns, and measurable brand growth.</p>
                                    </div>
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Social Media Management">
                                    </div>
                                    <div class="services__details-content">
                                        <h2 class="title-two">Our Social Media Management Support Includes</h2>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="1151" height="81" viewBox="0 0 1151 81" fill="currentColor">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-xl-8 col-lg-10" style="width: 100%;">
                                                    <div class="faq__wrap faq__wrap-three">
                                                        <div class="accordion" id="social-media-management-social-media-management-accordion">
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header">
                                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#social-media-management-social-media-management-collapseOne" aria-expanded="true" aria-controls="social-media-management-social-media-management-collapseOne">1. What is included in Social Media Management?</button>
                                                                </h2>
                                                                <div id="social-media-management-social-media-management-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#social-media-management-social-media-management-accordion">
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#social-media-management-social-media-management-collapseTwo" aria-expanded="false" aria-controls="social-media-management-social-media-management-collapseTwo">2. How do you measure performance?</button>
                                                                </h2>
                                                                <div id="social-media-management-social-media-management-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#social-media-management-social-media-management-accordion">
                                                                    <div class="accordion-body">
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#social-media-management-social-media-management-collapseThree" aria-expanded="false" aria-controls="social-media-management-social-media-management-collapseThree">3. Can you work with our existing brand?</button>
                                                                </h2>
                                                                <div id="social-media-management-social-media-management-collapseThree" class="accordion-collapse collapse" data-bs-parent="#social-media-management-social-media-management-accordion">
                                                                    <div class="accordion-body">
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#social-media-management-social-media-management-collapseFour" aria-expanded="false" aria-controls="social-media-management-social-media-management-collapseFour">4. Is ongoing support available?</button>
                                                                </h2>
                                                                <div id="social-media-management-social-media-management-collapseFour" class="accordion-collapse collapse" data-bs-parent="#social-media-management-social-media-management-accordion">
                                                                    <div class="accordion-body">
                            ...
                            <!-- Content Plan &amp; Stratergy Tab Panel -->
                            <div class="service-tab-panel" id="social-media-management-content-plan-and-stratergy" data-service-panel="social-media-management-content-plan-and-stratergy">
                                <div class="services__details-wrap">
                                    <div class="services__details-content-top">
                                    ...
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Content Plan &amp; Stratergy">
                                    </div>
                                    <div class="services__details-content">
                                        ...
                                        <div class="services__details-inner-images">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="img-one">
                                                        <img src="assets/img/services/services_img01.jpg" alt="Content Plan &amp; Stratergy">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="img-two">
                                                        <img src="assets/img/services/services_img02.jpg" alt="Content Plan &amp; Stratergy">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="1151" height="81" viewBox="0 0 1151 81" fill="currentColor">
                            ...
                            <!-- Content Plan &amp; Stratergy Tab Panel End --><!-- Content Plan &amp; Stratergy Tab Panel End -->
                            <!-- Content Creation Tab Panel -->
                            <div class="service-tab-panel" id="social-media-management-content-creation" data-service-panel="social-media-management-content-creation">
                                <div class="services__details-wrap">
                                    <div class="services__details-content-top">
                                    ...
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Content Creation">
                                    </div>
                                    <div class="services__details-content">
                                        ...
                                        <div class="services__details-inner-images">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="img-one">
                                                        <img src="assets/img/services/services_img01.jpg" alt="Content Creation">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="img-two">
                                                        <img src="assets/img/services/services_img02.jpg" alt="Content Creation">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="1151" height="81" viewBox="0 0 1151 81" fill="currentColor">
                            ...
                            <!-- Content Creation Tab Panel End --><!-- Content Creation Tab Panel End -->
                            <!-- Community Management Tab Panel -->
                            <div class="service-tab-panel" id="social-media-management-community-management" data-service-panel="social-media-management-community-management">
                                <div class="services__details-wrap">
                                    <div class="services__details-content-top">
                                    ...
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Community Management">
                                    </div>
                                    <div class="services__details-content">
                                        ...
                                        <div class="services__details-inner-images">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="img-one">
                                                        <img src="assets/img/services/services_img01.jpg" alt="Community Management">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="img-two">
                                                        <img src="assets/img/services/services_img02.jpg" alt="Community Management">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="1151" height="81" viewBox="0 0 1151 81" fill="currentColor">
                            ...
                            <!-- Community Management Tab Panel End --><!-- Community Management Tab Panel End -->
                            <!-- Influencer Marketing Tab Panel -->
                            <div class="service-tab-panel" id="social-media-management-influencer-marketing" data-service-panel="social-media-management-influencer-marketing">
                                <div class="services__details-wrap">
                                    <div class="services__details-content-top">
                                    ...
                                    <div class="services__details-thumb">
                                        <img src="assets/img/services/services_details_img01.jpg" alt="Influencer Marketing">
                                    </div>
                                    <div class="services__details-content">
                                        ...
                                        <div class="services__details-inner-images">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="img-one">
                                                        <img src="assets/img/services/services_img01.jpg" alt="Influencer Marketing">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="img-two">
                                                        <img src="assets/img/services/services_img02.jpg" alt="Influencer Marketing">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="1151" height="81" viewBox="0 0 1151 81" fill="currentColor">
                            ...
                            <!-- Influencer Marketing Tab Panel End --><!-- Influencer Marketing Tab Panel End -->
                        </div>
                        <div class="col-30">
                            <aside class="services__sidebar">
                                <div class="sidebar__widget">
                                    <div class="sidebar__cat-list">
                                        <ul class="list-wrap">
                                            <li>
                                                <a href="#social-media-management-social-media-management" class="service-tab-link is-active" data-service-tab="social-media-management-social-media-management">
                                            ...
                                            <li>
                                                <a href="#social-media-management-content-plan-and-stratergy" class="service-tab-link" data-service-tab="social-media-management-content-plan-and-stratergy">
                                                    Content Plan &amp; Stratergy
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="14" viewBox="0 0 24 14" fill="none">
                                                            <path d="M1 6.7777H22.6667M22.6667 6.7777L16.9683 1M22.6667 6.7777L16.9683 12.5556" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                            ...
                                            <li>
                                                <a href="#social-media-management-content-creation" class="service-tab-link" data-service-tab="social-media-management-content-creation">
                                                    Content Creation
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="14" viewBox="0 0 24 14" fill="none">
                                                            <path d="M1 6.7777H22.6667M22.6667 6.7777L16.9683 1M22.6667 6.7777L16.9683 12.5556" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            ...
                                            <li>
                                                <a href="#social-media-management-community-management" class="service-tab-link" data-service-tab="social-media-management-community-management">
                                            ...
                                            <li>
                                                <a href="#social-media-management-influencer-marketing" class="service-tab-link" data-service-tab="social-media-management-influencer-marketing">
