...
<body>
                                    ...
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Pages</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="career-details.php">Career Details</a></li>
    ...
    <main class="main-area fix">
        ...
        <!-- career-details-area -->
        <section class="career__details-area">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="career__details-content">
                            ...
                            <h3 class="salary">$1000 - $1200 <span>USD/ Monthly</span></h3>
                            <ul class="list-wrap">
                                <li><span>Position</span>IT Consultant</li>
                                <li><span>Location</span>1860 Hedge Street</li>
                    ...
                    <div class="col-lg-6">
                        <div class="apply__box">
                            ...
                            <a href="#!" class="tg-btn tg-btn-three">Apply Now at Bekko</a>
                            <p>Next, you'll face an assessment to proceed. Apply for one job at a time and prepare well.</p>
                            <p>* By applying for this job listing, you agree to our Data <a href="contact.php">Privacy Policy ↗</a> for recruitment and job applications.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="career__details-area-two section-py-130">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="career__details-content-two">
                            <h4 class="title">About</h4>
                            <p>A Business Analyst bridges the gap between business needs and technology solutions. They analyze data, identify business challenges, and propose strategic solutions to improve efficiency, profitability, and decision-making.</p>
                            <div class="career__details-content-inner">
                                ...
                                <ul>
                                    ...
                                    <li>Identify areas for process improvement and efficiency.</li>
                                    <li>Develop reports, dashboards, and visualizations using tools like Excel, Power BI, or Tableau.</li>
                                    <li>Collaborate with IT and development teams to implement solutions.</li>
                                    <li>Perform market and competitive analysis.</li>
                                    <li>Document business processes and recommend improvements.</li>
                                    <li>Conduct risk analysis and assess project feasibility.</li>
                                </ul>
                            </div>
                            <div class="career__details-content-inner">
                                ...
                                <ul>
                                    ...
                                    <li>Experience with data analysis tools (Excel, SQL, Power BI, Tableau).</li>
                            ...
                            <div class="career__details-content-inner">
                                ...
                                <ul>
                                    <li>Bachelor’s degree in Business, Finance, IT, or a related field.</li>
                                    <li>1-3 years of experience in business analysis, consulting, or a related role.</li>
                                    <li>Certifications like CBAP (Certified Business Analysis Professional) or PMI-PBA are a plus.</li>
                                </ul>
                            </div>
                            <div class="career__details-content-inner">
                                <h4 class="title">Salary Range:</h4>
                                <ul>
                                    <li>$60,000 – $90,000 per year (varies by location and industry).</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="career__details-benefit">
                            ...
                            <ul class="list-wrap">
                                <li><img src="assets/img/icons/benefit_icon01.svg" alt="icon">Competitive Salary</li>
                                <li><img src="assets/img/icons/benefit_icon02.svg" alt="icon">Comprehensive Health Coverage</li>
                                <li><img src="assets/img/icons/benefit_icon03.svg" alt="icon">Professional Development</li>
                                <li><img src="assets/img/icons/benefit_icon04.svg" alt="icon">Flexible Work Arrangements</li>
                                <li><img src="assets/img/icons/benefit_icon05.svg" alt="icon">Retirement Savings Plan</li>
                                <li><img src="assets/img/icons/benefit_icon06.svg" alt="icon">Paid Time Off (PTO) & Holidays</li>
                                <li><img src="assets/img/icons/benefit_icon07.svg" alt="icon">Collaborative & Inclusive Culture</li>
                                <li><img src="assets/img/icons/benefit_icon08.svg" alt="icon">Career Growth Opportunities</li>
                                <li><img src="assets/img/icons/benefit_icon09.svg" alt="icon">Wellness Programs</li>
                                <li><img src="assets/img/icons/benefit_icon10.svg" alt="icon">Company Social Events</li>
                            </ul>
                        </div>
                    </div>
                </div>
