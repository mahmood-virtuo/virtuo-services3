                    ...
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem">Our Team</span>
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row gutter-y-30 justify-content-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="team__item-three">
                            <div class="team__thumb-three">
                                <img src="assets/img/team/h5_team_img01.png" alt="img">
                            </div>
                            <div class="team__content-three">
                                <h2 class="title"><a href="team-details.php">Eleanor Pena</a></h2>
                                <span>Tax Advisor</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="team__item-three">
                            <div class="team__thumb-three">
                                <img src="assets/img/team/h5_team_img02.png" alt="img">
                            </div>
                            <div class="team__content-three">
                                <h2 class="title"><a href="team-details.php">Jane Cooper</a></h2>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="team__item-three">
                            <div class="team__thumb-three">
                                <img src="assets/img/team/h5_team_img03.png" alt="img">
                            </div>
                            <div class="team__content-three">
                                <h2 class="title"><a href="team-details.php">Jerome Bell</a></h2>
                                <span>Sr. Brand Designer</span>
                                <div class="team__social-three">
                                    <ul class="list-wrap">
                                        <li><a href="https://www.facebook.com/" target="_blank"><img src="assets/img/icons/facebook.svg" alt="" class="injectable"></a></li>
                                        <li><a href="https://x.com/home" target="_blank"><img src="assets/img/icons/twitter.svg" alt="" class="injectable"></a></li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="team__item-three">
                            <div class="team__thumb-three">
                                <img src="assets/img/team/h5_team_img04.png" alt="img">
                            </div>
                            <div class="team__content-three">
                                <h2 class="title"><a href="team-details.php">Leslie Alexander</a></h2>
