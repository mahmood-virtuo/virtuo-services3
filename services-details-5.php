...
<body>
                                    ...
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Services</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="services-details-5.php">Services Details Five</a></li>
                                            </ul>
                                        </li>
    ...
    <main class="main-area fix">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <h2 class="title">Securing Your Financial Future</h2>
        ...
        <div class="services__details-area-four section-py-130">
            <div class="container">
                ...
                <div class="services__details-thumb-four">
                    <img src="assets/img/services/sd5_img01.jpg" alt="img">
                </div>
            </div>
        </div>
        ...
        <!-- project-solution-area -->
        <section class="project__solution-area section-py-130">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="project__solution-thumb">
                            <img src="assets/img/services/sd5_img02.jpg" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="project__solution-content">
                            <div class="section__title section__title-two mb-40">
                                <span class="sub-title">Solution Approach</span>
                                <h2 class="title">Project Solutions</h2>
                            </div>
                            <div class="project__solution-item-wrap">
                                <div class="project__solution-item">
                                    <h4 class="title">1. Financial Assessment & Goal Setting</h4>
                                    <p>Conduct a detailed review of current financial status, including income, expenses, and assets.</p>
                                </div>
                                <div class="project__solution-item">
                                    <h4 class="title">2. Portfolio Diversification</h4>
                                    <p>Include a mix of asset classes such as stocks, bonds, mutual funds, real estate, and alternative investments.</p>
                                </div>
                                <div class="project__solution-item">
                                    <h4 class="title">3. Customised Investment Plans</h4>
                                    <p>Develop investment strategies tailored to risk tolerance and investment horizon.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section__title text-center mb-40">
                            ...
                            <h2 class="title">Outline the process <br> your agency</h2>
                        </div>
                    </div>
                </div>
