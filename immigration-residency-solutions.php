                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="section__title text-center mb-60">
                                                    ...
                                                    <h2 class="title">Your UAE Residency Journey, Simplified</h2>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="work__item-two text-center">
                                                        ...
                                                        <div class="work__content-two">
                                                            ...
                                                            <h3 class="title">Eligibility Check</h3>
                                                            <p>Clear Assessment</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="work__item-two text-center">
                                                        ...
                                                        <div class="work__content-two">
                                                            ...
                                                            <h3 class="title">File Preparation</h3>
                                                            <p>Document Ready</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="work__item-two text-center">
                                                        ...
                                                        <div class="work__content-two">
                                                            ...
                                                            <h3 class="title">Government Processing</h3>
                                                            <p>Status Tracking</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="work__item-two text-center">
                                                        ...
                                                        <div class="work__content-two">
                                                            ...
                                                            <h3 class="title">Visa Completion</h3>
                                                            <p>Final Handover</p>
                                                        </div>
                                                    </div>
                                                </div>
