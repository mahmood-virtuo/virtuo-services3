                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active menu-item-has-children"><a href="shop.php">Shop</a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="cart.php">Cart Page</a></li>
                ...
                <div class="row">
                            ...
                            <tbody>
                                <tr>
                                    <td class="product__thumb">
                                        <a href="shop-details.php"><img src="assets/img/shop/shop_img01.png" alt=""></a>
                                    </td>
                                    <td class="product__name">
                                        <a href="shop-details.php">Brand New Women Red</a>
                                    </td>
                                ...
                                <tr>
                                    <td class="product__thumb">
                                        <a href="shop-details.php"><img src="assets/img/shop/shop_img02.png" alt=""></a>
                                    </td>
                                    <td class="product__name">
                                        <a href="shop-details.php">100% Casual Full Sleeve</a>
                                    </td>
                    ...
                    <div class="col-lg-4">
                        <div class="cart__collaterals-wrap">
                            ...
                            <a href="check-out.php" class="tg-btn">Proceed to checkout</a>
                        </div>
                    </div>
                </div>
            </div>
