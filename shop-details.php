                ...
                <div class="row justify-content-center">
                        ...
                        <div class="shop__details-images-wrap">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane show active" id="itemOne-tab-pane" role="tabpanel" aria-labelledby="itemOne-tab" tabindex="0">
                                    ...
                                    <a href="assets/img/shop/shop_details-img01.jpg" class="popup-image expand-img">
                                        <img src="assets/img/icons/expand.svg" alt="" class="injectable">
                                    </a>
                                ...
                                <div class="tab-pane" id="itemThree-tab-pane" role="tabpanel" aria-labelledby="itemThree-tab" tabindex="0">
                                    <span class="flash-sale">-10%</span>
                                    <a href="assets/img/shop/shop_details-img03.jpg" class="popup-image expand-img">
                                        <img src="assets/img/icons/expand.svg" alt="" class="injectable">
                                    </a>
                                ...
                                <div class="tab-pane" id="itemFour-tab-pane" role="tabpanel" aria-labelledby="itemFour-tab" tabindex="0">
                                    <span class="flash-sale">-10%</span>
                                    <a href="assets/img/shop/shop_details-img04.jpg" class="popup-image expand-img">
                                        <img src="assets/img/icons/expand.svg" alt="" class="injectable">
                                    </a>
                    ...
                    <div class="col-lg-6">
                        <div class="shop__details-content">
                            <h2 class="title">The latest iPhone 15 Pro Max with Blue Solid Color 256GB</h2>
                            <ul class="shop__details-review-wrap list-wrap">
                                <li>
                                ...
                                <li class="product-sku">SKU: <span>#AP1234</span></li>
                                <li class="product-availability">Availability: <span>In Stock</span></li>
                            </ul>

                            <h3 class="price">$1,340.00 <del>$1,824.00</del></h3>
                            <div class="shop__details-content-inner">
                                <p>Nam tempus turpis at metus scelerisque placerat nulla deumantos felis are Pellentesque diam dolor, elementum etos lobortis...</p>
                                <ul class="list-wrap">
                            ...
                            <div class="shop__details-color">
                                <span class="title">Color: <strong>Blue</strong></span>
                                <ul class="list-wrap">
                                    <li></li>
                                    <li></li>
                                    <li></li>
                            ...
                            <div class="shop__details-qty">
                                ...
                                <a href="shop-details.php" class="tg-btn tg-btn-three cart-btn"><img src="assets/img/icons/cart.svg" alt="" class="injectable">Add To Cart</a>
                            </div>
                            <div class="shop__details-wishlist-wrap">
                                <a href="shop-details.php"><i class="far fa-heart"></i>Add to Wishlist</a>
                                <a href="shop-details.php"><img src="assets/img/icons/compar.svg" alt="" class="injectable">Add to Compare</a>
                            </div>
                            <div class="shop__details-bottom">
                                <ul class="list-wrap">
                                    <li class="sd-category">
                                        <span class="title">Categories:</span>
                                        <a href="shop-details.php">Electronics</a>
                                    </li>
                                    <li class="sd-tag">
                                        <span class="title">Tags:</span>
                                        <a href="shop-details.php">Accessories,</a>
                                        <a href="shop-details.php">Headphone,</a>
                                        <a href="shop-details.php">Modern</a>
                                    </li>
                                    <li class="sd-social">
                    ...
                    <div class="col-12">
                        <div class="product-desc-wrap">
                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description-tab-pane" type="button" role="tab" aria-controls="description-tab-pane" aria-selected="true">Product Description</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="shop__item">
                                <div class="shop__thumb">
                                    ...
                                    <ul class="list-wrap shop__action">
                                        ...
                                        <li><a href="shop-details.php"><img src="assets/img/icons/quick-view.svg" alt="" class="injectable"></a>
                                        </li>
                                    </ul>
                                </div>
