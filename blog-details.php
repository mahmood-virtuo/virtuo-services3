                    ...
                    <div class="col-70">
                        <div class="blog__details-wrap">
                            ...
                            <div class="blog__details-content">
                                ...
                                <h2 class="title">Get a few solutions to hire a best candidate</h2>
                                ...
                                <p>For dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vestibulum lorem sed risus ultricies tristique nulla. Sem viverra aliquet eget sit amet tellus cras adipiscing. Varius sit amet mattis vulputate enim nulla.</p>
                                <blockquote>
                                    <p>“ Modern lifeblood of mobile phones and tablets toda The true potential your mob phone  tions  can provide utility. Apps come under variousof mobile. ”</p>
                                ...
                                <p>When an unknown printer took a galley  type remaining essentially unchan galley of type and scrambled it to make a type specimen book.hole planet, providing a health threat to many countries. As a result, it is critical to give it equal weight. With escalating levels of dynamic disaster risk coming from social polarization, rapidly rising poverty levels.</p>
                                        ...
                                        <div class="col-md-7">
                                            <div class="post-tags">
                                                ...
                                                <ul class="list-wrap">
                                                    ...
                                                    <li><a href="blog.php">Agency Theme</a></li>
                                                    <li><a href="blog.php">Marketing Team</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                            ...
                            <div class="comment-respond">
                                ...
                                <form action="#" class="comment-form">
                                    ...
                                    <button type="submit" class="tg-btn tg-btn-three">Submit Comment</button>
                                </form>
                            </div>
                        </div>
                    </div>
