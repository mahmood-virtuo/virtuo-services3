...
<head>
    ...
    $seoPage = array(
        ...
        'type' => 'article',
        'breadcrumbTitle' => 'UAE Business Formation, Structuring & Compliance',
        'schemaType' => 'Service',
        'serviceType' => 'UAE business formation and compliance',
...
<body>
    ...
    $breadcrumbPageUrl = '/uae-business-formation';
                                    ...
                                    <div class="estimate-form-wrap virtuo-sidebar-form">
                                        <form id="footer-quote-form" action="assets/mail.php" method="POST">
                                            ...
                                            <div class="sidebar-form-benefits">
                                                ...
                                                <ul>
                                                    <li>100% Foreign Ownership Options</li>
                                                    <li>Latest Setup Requirements</li>
                                                    <li>Post-Setup Requirements</li>
                                                </ul>
                                            </div>

                                            <button class="tg-btn tg-btn-seven" type="submit">Schedule a Free Consultation</button>
