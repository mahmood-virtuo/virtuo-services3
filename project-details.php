                                    ...
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Portfolio</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="project-details.php">Portfolio Details One</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <h2 class="title">10x Business Growth</h2>
                    ...
                    <div class="col-70">
                        <div class="project__details-wrap">
                            ...
                            <div class="project__details-content">
                                <h2 class="title">Digital Strategy Consulting</h2>
                                ...
                                <div class="project__details-challenge">
                                    <h2 class="title-two">Project Challenges</h2>
                                    <p>when an unknown printer took a galley offer typey anddey scrambled  make a type specimen bookhas survived not only five when an unknown printer took a galley of type and scrambled it to make a type specimenscrambled  make a type specimen bookha.</p>
                                    <ul class="list-wrap about__list-item-two about__list-item-three">
                                        <li>
                                            <div class="icon">
                                ...
                                <div class="project__details-report">
                                    <h2 class="title-two">Reports Analysis</h2>
                                    ...
                                    <div class="project__details-report-inner">
                        ...
                        <aside class="project__sidebar">
                            <div class="sidebar__widget">
                                <div class="project__details-info-wrap">
                                    ...
                                    <ul class="list-wrap">
                                        ...
                                        <li><span>Date:</span>17 March, 2025</li>
                            ...
                            <div class="sidebar__widget">
                                <div class="project__details-contact">
                                    <a href="tel:0123456789"><i class="flaticon-phone-call"></i>+123 98989 500</a>
                                    <a href="mailto:mgmt@virtuo.ae"><i class="flaticon-envelope"></i>mgmt@virtuo.ae</a>
                                </div>
                            </div>
                        </aside>
                    </div>
