                                    ...
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Pages</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active menu-item-has-children"><a href="shop.php">Shop</a>
                                                    <ul class="sub-menu">
                ...
                <div class="row">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 col-sm-7">
                                    <div class="shop__top-left">
                                        <p>Showing 1-16 of 38 results</p>
                                    </div>
                                </div>
                            ...
                            <div class="row gy-4">
                                    ...
                                    <div class="shop__item">
                                        <div class="shop__thumb">
                                            <a href="shop-details.php">
                                                <img src="assets/img/shop/shop_img01.png" alt="img">
                                            </a>
                                            <span class="flash-sale">-10%</span>
                                            <ul class="list-wrap shop__action">
                                                <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                                <li><a href="shop-details.php"><img src="assets/img/icons/cart.svg" alt="" class="injectable"></a></li>
                                                <li><a href="shop-details.php"><img src="assets/img/icons/compar.svg" alt="" class="injectable"></a></li>
                                                <li><a href="shop-details.php"><img src="assets/img/icons/quick-view.svg" alt="" class="injectable"></a></li>
                                            </ul>
                                        </div>
                                        <div class="shop__content">
                                            <a href="shop.php" class="tag">Accessories</a>
                                            <h3 class="title"><a href="shop-details.php">Brand New Women Red Label ARDEEN Ladies Bag</a></h3>
                                            <div class="rating">
                                                ...
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <span class="avg">(06)</span>
                                            </div>
                                            <h4 class="price">$90.00<del>$1,400.00</del></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-sm-6">
                                    <div class="shop__item">
                                        <div class="shop__thumb">
                                            <a href="shop-details.php">
                                                <img src="assets/img/shop/shop_img02.png" alt="img">
                                            </a>
                                            <span class="flash-sale">-10%</span>
                                            <ul class="list-wrap shop__action">
                                                <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="shop__content">
                                            <a href="shop.php" class="tag">Clothing</a>
                                            <h3 class="title"><a href="shop-details.php">100% Casual Full Sleeve Black Shirt For Man</a></h3>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                            ...
                                            <h4 class="price">$20.00<del>$23.00</del></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-sm-6">
                                    <div class="shop__item">
                                        <div class="shop__thumb">
                                            <a href="shop-details.php">
                                                <img src="assets/img/shop/shop_img03.png" alt="img">
                                            </a>
                                            <span class="flash-sale new">New</span>
                                            <ul class="list-wrap shop__action">
                                                <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                                <li><a href="shop-details.php"><img src="assets/img/icons/cart.svg" alt="" class="injectable"></a></li>
                                                <li><a href="shop-details.php"><img src="assets/img/icons/compar.svg" alt="" class="injectable"></a></li>
                                        ...
                                        <div class="shop__content">
                                            <a href="shop.php" class="tag">Smart watch</a>
                                            <h3 class="title"><a href="shop-details.php">The Most Hyparei Break Kit for SUV Models</a></h3>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <div class="shop__item">
                                        <div class="shop__thumb">
                                            <a href="shop-details.php">
                                                <img src="assets/img/shop/shop_img04.png" alt="img">
                                            </a>
                                            <ul class="list-wrap shop__action">
                                                <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                                <li><a href="shop-details.php"><img src="assets/img/icons/cart.svg" alt="" class="injectable"></a></li>
                                        ...
                                        <div class="shop__content">
                                            <a href="shop.php" class="tag">Shoes</a>
                                            <h3 class="title"><a href="shop-details.php">Women's Raya Mid Stiletto Sandals</a></h3>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <div class="shop__item">
                                        <div class="shop__thumb">
                                            <a href="shop-details.php">
                                                <img src="assets/img/shop/shop_img05.png" alt="img">
                                            </a>
                                            <span class="flash-sale new">New</span>
                                            <ul class="list-wrap shop__action">
                                                <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="shop__content">
                                            <a href="shop.php" class="tag">Furniture</a>
                                            <h3 class="title"><a href="shop-details.php">The Most Hyparei Break Kit for SUV Models</a></h3>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                ...
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <span class="avg">(07)</span>
                                            </div>
                                            <h4 class="price">$450.00</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-sm-6">
                                    <div class="shop__item">
                                        <div class="shop__thumb">
                                            <a href="shop-details.php">
                                                <img src="assets/img/shop/shop_img06.png" alt="img">
                                            </a>
                                            <ul class="list-wrap shop__action">
                                                <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                                <li><a href="shop-details.php"><img src="assets/img/icons/cart.svg" alt="" class="injectable"></a></li>
                                        ...
                                        <div class="shop__content">
                                            <a href="shop.php" class="tag">Accessories</a>
                                            <h3 class="title"><a href="shop-details.php">Samsung Smart Washing Machine 880 Litter</a></h3>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <span class="avg">(03)</span>
                                            </div>
                                            <h4 class="price">$600.00</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-sm-6">
                                    <div class="shop__item">
                                        <div class="shop__thumb">
                                            <a href="shop-details.php">
                                                <img src="assets/img/shop/shop_img07.png" alt="img">
                                            </a>
                                            <span class="flash-sale new">New</span>
                                            <ul class="list-wrap shop__action">
                                                <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="shop__content">
                                            <a href="shop.php" class="tag">Phone</a>
                                            <h3 class="title"><a href="shop-details.php">The Most Hyparei Break Kit for SUV Models</a></h3>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                ...
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <span class="avg">(10)</span>
                                            </div>
                                            <h4 class="price">$130.00<del>$1,400.00</del></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-sm-6">
                                    <div class="shop__item">
                                        <div class="shop__thumb">
                                            <a href="shop-details.php">
                                                <img src="assets/img/shop/shop_img08.png" alt="img">
                                            </a>
                                            <span class="flash-sale">-10%</span>
                                            <ul class="list-wrap shop__action">
                                                <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="shop__content">
                                            <a href="shop.php" class="tag">Bag Pack</a>
                                            <h3 class="title"><a href="shop-details.php">Travel Bag Pack For Huge Changes</a></h3>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                            ...
                                            <h4 class="price">$10.00<del>$12.00</del></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-sm-6">
                                    <div class="shop__item">
                                        <div class="shop__thumb">
                                            <a href="shop-details.php">
                                                <img src="assets/img/shop/shop_img09.png" alt="img">
                                            </a>
                                            <span class="flash-sale">-10%</span>
                                            <ul class="list-wrap shop__action">
                                                <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="shop__content">
                                            <a href="shop.php" class="tag">Shoes</a>
                                            <h3 class="title"><a href="shop-details.php">Most Comfortable Running Shoes for Men</a></h3>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <span class="avg">(09)</span>
                                            </div>
                                            <h4 class="price">$45.00<del>$50.00</del></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-30">
                        <aside class="shop__sidebar">
                            ...
                            <div class="sidebar__widget">
                                <h4 class="sidebar__widget-title">Filter By Categories</h4>
                                <div class="shop__cat-list">
                                    <ul class="list-wrap">
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_1">
                                                <label class="form-check-label" for="cat_1">All Categories (23)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_2">
                                                <label class="form-check-label" for="cat_2">Women (23)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_3">
                                                <label class="form-check-label" for="cat_3">kid’s (23)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_4">
                                                <label class="form-check-label" for="cat_4">electronics (23)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_5">
                                                <label class="form-check-label" for="cat_5">Furniture (23)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_6">
                                                <label class="form-check-label" for="cat_6">Smart Watch (23)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_7">
                                                <label class="form-check-label" for="cat_7">Laptop (23)</label>
                                            </div>
                                        </li>
                                    </ul>
                                    <div class="show-more">
                            ...
                            <div class="sidebar__widget">
                                <h4 class="sidebar__widget-title">Price Range</h4>
                                ...
                                <button type="submit" class="tg-btn tg-btn-three shop__price-btn">Filter Now</button>
                            </div>
                            <div class="sidebar__widget">
                                <h4 class="sidebar__widget-title">Shop by Color</h4>
                                <div class="shop__cat-list">
                                    <ul class="list-wrap">
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="color_1">
                                                <label class="form-check-label" for="color_1">Gray <span>(12)</span></label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="color_2">
                                                <label class="form-check-label" for="color_2">Orange <span>(10)</span></label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="color_3">
                                                <label class="form-check-label" for="color_3">Pink <span>(09)</span></label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="color_4">
                                                <label class="form-check-label" for="color_4">Green <span>(07)</span></label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="color_5">
                                                <label class="form-check-label" for="color_5">Blue <span>(05)</span></label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="color_6">
                                                <label class="form-check-label" for="color_6">Yellow <span>(02)</span></label>
                                            </div>
                                        </li>
                                    </ul>
                                    <div class="show-more">
                            ...
                            <div class="sidebar__widget">
                                <h4 class="sidebar__widget-title">Filter By Ratings</h4>
                                <div class="shop__cat-list shop__rating-list">
                                    <ul class="list-wrap">
                                        <li>
                                            <div class="form-check">
