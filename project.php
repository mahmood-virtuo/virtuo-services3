                                ...
                                <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-lg-flex">
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Portfolio</a>
                                            <ul class="sub-menu">
                                                <li class="active"><a href="project.php">Portfolio Page</a></li>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="section__title mb-50 mb-md-30">
                            ...
                            <h2 class="title">Our dedication shines <br> through our work</h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row gutter-y-30">
                    <div class="col-lg-4 col-md-6">
                        <div class="project__item-five">
                            <div class="project__thumb-five">
                                <a href="project-details.php"><img src="assets/img/project/h5_project_img01.jpg" alt="img"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="project__item-five">
                            <div class="project__thumb-five">
                                <a href="project-details.php"><img src="assets/img/project/h5_project_img02.jpg" alt="img"></a>
                            </div>
                            <div class="project__content-five">
                                <span>Strategy Map</span>
                                <h2 class="title"><a href="project-details.php">Web Development</a></h2>
                                <a href="project-details.php" class="arrow tg-btn tg-btn-four"><img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="project__item-five">
                            <div class="project__thumb-five">
                                <a href="project-details.php"><img src="assets/img/project/h5_project_img03.jpg" alt="img"></a>
                            </div>
                            <div class="project__content-five">
                                <span>Planning</span>
                                <h2 class="title"><a href="project-details.php">Business Planning</a></h2>
                                <a href="project-details.php" class="arrow tg-btn tg-btn-four"><img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="project__item-five">
                            <div class="project__thumb-five">
                                <a href="project-details.php"><img src="assets/img/project/h5_project_img04.jpg" alt="img"></a>
                            </div>
                            <div class="project__content-five">
                                <span>Data Process</span>
                                <h2 class="title"><a href="project-details.php">Big Data & Analytics</a></h2>
                                <a href="project-details.php" class="arrow tg-btn tg-btn-four"><img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="project__item-five">
                            <div class="project__thumb-five">
                                <a href="project-details.php"><img src="assets/img/project/h5_project_img05.jpg" alt="img"></a>
                            </div>
                            <div class="project__content-five">
                                <span>Business</span>
                                <h2 class="title"><a href="project-details.php">Data Management</a></h2>
                                <a href="project-details.php" class="arrow tg-btn tg-btn-four"><img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="project__item-five">
                            <div class="project__thumb-five">
                                <a href="project-details.php"><img src="assets/img/project/h5_project_img06.jpg" alt="img"></a>
                            </div>
                            <div class="project__content-five">
                                <span>Business Strategy</span>
                                <h2 class="title"><a href="project-details.php">10x Business Growth</a></h2>
