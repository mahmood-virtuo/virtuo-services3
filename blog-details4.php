...
<head>
    ...
    $seoPage = array(
        ...
        'path' => '/blog/the-uae-golden-visa-comparing-every-real-way-to-qualify',
        'type' => 'article',
        'breadcrumbTitle' => 'UAE Golden Visa Eligibility Guide',
        'schemaType' => 'Article',
        'heroImage' => '/assets/img/slider/4th_blog.webp',
        'heroImageMobile' => '/assets/img/services/GoldenVisaImg1.webp'
    );
...
<main class="main-area fix">
      <section class="slider__area blog-static-hero">
                    <div class="slider__bg hero-image-styles" data-background="/assets/img/slider/4th_blog.webp" data-background-mobile="/assets/img/services/GoldenVisaImg1.webp">
